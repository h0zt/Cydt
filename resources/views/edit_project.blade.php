    ...
    <form action="{{ route('update',$project->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-xs-12 col-sm-12 col-md-6">
            ...
            <div class="form-group">
                <input type="text" name="name" value="{{ $project->name }}" class="border-light form-control" placeholder="Name">
            </div>
        
            <div class="form-group">
                <textarea class="border-light form-control" style="height:150px" name="detail" placeholder="Detail">{{ $project->detail }}</textarea>
            </div>
