    ...
    <form action="{{ route('store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-12 col-md-6">
            <div class="form-group">
                <input type="text" name="name" class="border-light form-control" placeholder="Name">
            </div>
      
            <div class="form-group">
                <textarea class="border-light form-control" style="height:150px" name="detail" placeholder="Detail"></textarea>
            </div>
