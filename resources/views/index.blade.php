...
<head>
	...
	<link rel="stylesheet" href="assets/css/host.bckyrd.css">
</head>
<body>
    <!-- ? Preloader Start -->
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-8 col-sm-10">
                            <div class="hero__caption">
                                <h1 data-animation="fadeInUp" data-delay=".6s">Center for youth  Development and Transformation.<br>(CYDT)</h1>
                                <P data-animation="fadeInUp" data-delay=".8s" >"an empowered," developed society is very possible. </P>
                                <!-- Hero-btn -->
                                <div class="hero__btn">
                                    <a href="#about" class="btn hero-btn mb-10"  data-animation="fadeInLeft" data-delay=".8s">Learn More</a>
                                    <a href="#phone_number" class="cal-btn ml-15" data-animation="fadeInRight" data-delay="1.0s">
            ...
            <div class="single-slider slider-height d-flex align-items-center">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-8 col-sm-10">
                            <div class="hero__caption">
                                <h1 data-animation="fadeInUp" data-delay=".6s">CYDT CORE VALUES</h1>
                                    <P data-animation="fadeInUp" data-delay=".8s" >like Honesty and Trustworthy.
Integrity,Accountability, Transparency, Unity and Teamwork, Tolerance ,Confidentiality. We treat, Volunteerism, Community Partnership and Participation ,Excellence ,Dignity, Creativity and Innovation.</P>
                                <!-- Hero-btn -->
                            </div>
                        </div>
                    </div>
    ...
    <!-- Services Area End -->
    <!--? About Law Start-->
    <section class="about-low-area section-padding30" id="about">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 pl-50">
                    <div class="about-caption ">
                        ...
                        <p>To improve the lives of citizens by equipping them with knowledge and skills as well as
championing the principles and practices of youth development, governance, human rights,
climate change, good health and collaboration thereby unleashing their full potential in society.
</p>
                        <p>The vision is to create :An empowered, developed and responsible health young people, with our core values.</p>
                    </div>
                    <a href="#projects" class="btn">view activities</a>
                </div>
            </div>
        </div>
    </section>
    <!-- About Law End-->
    <!-- Our Cases Start -->
    <section class="our-cases-area section-padding30" id="projects">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-7 col-md-10 col-sm-10">
                    ...
                    <div class="section-tittle text-center mb-80">
                        ...
                        <h2>Select Projects Below To See Details Of Our Work</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-cases mb-40">
                        <div class="cases-img" style="height:35vh">
                            <a href="project">
    ...
    <!-- Our Cases End -->
    <!-- Featured_job_start -->
    <section class="featured-job-area section-padding30 section-bg2" data-background="assets/img/gallery/section_bg03.png" hidden>
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-7 col-lg-9 col-md-10 col-sm-12">
                    ...
                    <div class="section-tittle text-center mb-80">
                        ...
                        <h2>We arrange many social projects for charity donations</h2>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
                    ...
                    <div class="single-job-items mb-30">
                        <div class="job-items">
                            <div class="company-img">
                                <a href="#"><img src="assets/img/gallery/socialprojects1.png" alt=""></a>
                            </div>
                ...
                <div class="col-lg-9 col-md-12">
                    ...
                    <div class="single-job-items mb-30">
                        <div class="job-items">
                            <div class="company-img">
                                <a href="#"><img src="assets/img/gallery/socialprojects2.png" alt=""></a>
                            </div>
                            <div class="job-tittle">
                ...
                <div class="col-lg-9 col-md-12">
                    ...
                    <div class="single-job-items mb-30">
                        <div class="job-items">
                            <div class="company-img">
                                <a href="#"><img src="assets/img/gallery/socialprojects3.png" alt=""></a>
                            </div>
                            <div class="job-tittle">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-7 col-md-10 col-sm-10">
                    ...
                    <div class="section-tittle section-tittle2 text-center mb-70">
                        ...
                        <h2>Our Staff Always Ready To Speak To You.</h2>
                    </div> 
                </div>
            </div>
            <div class="row justify-content-right">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-team mb-30 ">
                        <div class="team-img" style="height:45vh">
                        ...
                        <div class="team-caption">
                            <h3><a href="instructor.html">Charles Nyelere</a></h3>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-team mb-30">
                        ...
                        <div class="team-caption">
                            <h3><a href="instructor.html">King Milos</a></h3>
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-xl-5 col-lg-9 col-md-8">
                        <div class="wantToWork-caption wantToWork-caption2">
                            <h2>Lets Transform Community Together</h2>
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-3 col-md-4">
                        <a href="#contact" class="btn white-btn f-right sm-left">Become A Volunteer</a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="testimonial-caption ">
                                ...
                                <div class="testimonial-founder">
                                    <div class="founder-img mb-40">
                                        ...
                                        <span>Phillip Nyoni</span>
                                        <p>Founder</p>
                                    </div>
                                </div>
                                <div class="testimonial-top-cap">
                                    <p>“Center for Youth Development and Transformation is a non-governmental, non-partisan and 
non-profit making local organisation established as a youth club in 2001 and got accredited to 
run as a youth organisation by National Youth Council of Malawi in 2005, and then registered as 
a limited company by registrar general in 2014,”</p>
                                </div>
                            </div>
                        </div>
                        <!-- Single Testimonial -->
                        <div class="single-testimonial text-center">
                            <div class="testimonial-caption ">
                                ...
                                <div class="testimonial-top-cap">
                                    <p>“With purpose of improving lives of citizens by 
equipping them with knowledge and skills as well as championing the principals and practices of 
youth and child development in human rights, climate change and good health thereby 
unleashing their full potential in the society. We are currently working in 6 districts ”</p>
                                </div>
                            </div>
                        </div>
    ...
    <section class="contact-section " id="contact">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-7 col-md-10 col-sm-10">
                    ...
                    <div class="section-tittle text-center mb-80">
                        ...
                        <h2>Visit Us Or Reach Us On Details Below </h2>
                    </div>
                </div>
            </div>
        </div>
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 offset-lg-1" id="phone_number">
                    <div class="media contact-info">
                        <span class="contact-info__icon"><i class="ti-home"></i></span>
                        <div class="media-body">
                            <h3>Thyolo, Malawi.</h3>
                            <p>POST OFFICE BOX 33 LUCHENZA</p>
                        </div>
                    </div>
                    <div class="media contact-info">
